...
## Corpus Check
- 734 files · ~1,342,927 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3195 nodes · 4989 edges · 75 communities detected
...
Cohesion: 0.03
Nodes (118): composeLLM(), fallbackReply(), isGreeting(), runConcierge(), systemFor(), userContent(), answerProcurement(), commitInterruptedProc() (+110 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (76): submit(), decide(), inr(), submit(), daysLeft(), digits(), doEnable(), intlPhone() (+68 more)
...
Cohesion: 0.03
Nodes (40): tradeWords(), call(), issue(), prog(), seed(), task(), bestTokenOverlap(), pickTokens() (+32 more)
...
- **Why does `parseAmount()` connect `Community 3` to `Community 8`, `Community 20`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `NewInvoice()` connect `Community 20` to `Community 11`, `Community 8`, `Community 3`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `saveRefBill()` connect `Community 3` to `Community 12`?**
