...
## Corpus Check
- 714 files · ~1,318,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3112 nodes · 4850 edges · 77 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 683 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (136): bindingKey(), graphIsMaterialized(), materializeProjectTasksUncached(), placeOfTask(), gatesByTask(), gatesFromBinding(), safeGeometry(), safeInstantiate() (+128 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (34): baseSeed(), twoAskSeed(), tUpdated(), upd(), ctxFor(), imgCtx(), tQItem(), tTaskUpdate() (+26 more)
...
Cohesion: 0.04
Nodes (103): answerTransaction(), applyPlan(), applyPrefix(), attachProofImage(), buildPlan(), cancelTransaction(), commitEntry(), commitInterrupted() (+95 more)
...
Cohesion: 0.03
Nodes (67): composeLLM(), fallbackReply(), isGreeting(), runConcierge(), systemFor(), userContent(), stampPossibleFollowup(), file() (+59 more)
...
Cohesion: 0.05
Nodes (23): billDateOf(), addAdjustment(), bookConsolidatedBill(), loadPartyLedger(), num(), saveOpeningBalance(), addRecurring(), recordWeeklyPayment() (+15 more)
...
Cohesion: 0.21
Nodes (11): fanOutQc(), persistGraph(), reconcile(), toPersistRows(), generateSiteTasks(), planReplaceAll(), toInsertRows(), currentMaxTaskNumber() (+3 more)
...
- **Why does `parseAmount()` connect `Community 4` to `Community 21`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `NewInvoice()` connect `Community 21` to `Community 16`, `Community 4`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `add()` connect `Community 16` to `Community 21`?**
