# Graph Report - Briklay Fly  (2026-09-12)

## Corpus Check
- 824 files · ~1,476,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3585 nodes · 5669 edges · 79 communities detected
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 871 edges (avg confidence: 0.8)
...
- `mondayOf()` --calls--> `loadWeeklyPaid()`  [INFERRED]
  src\lib\attendanceApi.ts → src\lib\weeklyPaymentsApi.ts
- `buildPartyStatementDoc()` --calls--> `fmtDate()`  [INFERRED]
  src\lib\ledgerStatementPdf.ts → src\pages\StakeholderDetail.tsx
...
Cohesion: 0.01
Nodes (116): answerSiteops(), answerWithPhoto(), applyBatchResolution(), applyQcFailures(), applyTaskBlockedById(), applyTaskProgressById(), applyTaskUpdate(), applyTerminals() (+108 more)
...
Cohesion: 0.02
Nodes (134): answerBillPayment(), attachBillDoc(), billAi(), billRawText(), billReplyKind(), findPrecedingCaption(), fmtNum(), isCleanAmount() (+126 more)
...
Cohesion: 0.02
Nodes (91): submit(), remove(), saveDate(), decide(), inr(), submit(), daysLeft(), digits() (+83 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (83): inr(), rupees(), Thumb(), intakeCommit(), intakeExtract(), intakeResolveVendor(), runIntake(), linkParts() (+75 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (72): wa(), saidAsOf(), buildComponents(), buildTemplateMessage(), sendTemplate(), line(), promptFor(), withTask() (+64 more)
...
Cohesion: 0.03
Nodes (68): composeLLM(), fallbackReply(), isGreeting(), runConcierge(), systemFor(), userContent(), commitInterruptedProc(), classifyPhotoFollowup() (+60 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (43): NewBillModal(), DragSheet(), PeekLink(), handleSave(), suggestCostCode(), fmtDate(), Label(), summarizeScope() (+35 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (41): AttendanceSheet(), isoOf(), confirm(), commit(), readStoredSession(), useAuth(), useCan(), useOrgId() (+33 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (49): addOpening(), allocateToCredit(), allocateToPool(), certifyStage(), createCredit(), fillCredit(), num(), openCreditsFor() (+41 more)
...
Cohesion: 0.07
Nodes (35): balStr(), buildPartyStatementDoc(), downloadPartyStatement(), money(), ordered(), amountInWords(), amountText(), dataPair() (+27 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (38): closeSheet(), contractPct(), countOf(), end(), engagementForm(), esc(), fail(), go() (+30 more)
...
Cohesion: 0.12
Nodes (26): commitEdit(), buildConfirmMsg(), buildDescription(), createRoughEntry(), fetchImageAsBase64(), findTopMatches(), fmtAmount(), handleFinancial() (+18 more)
...
## Knowledge Gaps
- **Thin community `Community 33`** (17 nodes): `no_such_floor_ask.test.ts`, `base()`, `blindModel()`, `convoOf()`, `ctxPin()`, `geo()`, `imgCtx()`, `model()`, `preambleOf()`, `projConvoOf()`, `row()`, `seed()`, `SEED2()`, `shortlist()`, `stateWrites()`, `textCtx()`, `tUpd()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (15 nodes): `add()`, `capitalizeWords()`, `FieldQuestion()`, `fieldStyle()`, `h()`, `matchGenHeads()`, `normHead()`, `openCreate()`, `pickGeneralHead()`, `rm()`, `selectPayee()`, `uid()`, `up()`, `update()`, `ResolvePopup.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 59`** (8 nodes): `held_project_fold.test.ts`, `convoOf()`, `ctxFor()`, `it()`, `model()`, `projectSlots()`, `R_CREATE()`, `seed()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (6 nodes): `BootLoader()`, `isBooted()`, `markBooted()`, `onBooted()`, `BootLoader.tsx`, `bootSignal.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 80`** (5 nodes): `FinancialsCashflow()`, `fmt()`, `lastNMonths()`, `monthLabel()`, `FinancialsCashflow.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (4 nodes): `handleClose()`, `handleSubmit()`, `updateRow()`, `QuoteEntryDrawer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (4 nodes): `bloom()`, `Btn()`, `REDUCED()`, `Btn.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (4 nodes): `poGateState()`, `poIsPriced()`, `poPayState()`, `poLifecycle.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (4 nodes): `evaluate.test.ts`, `blockworkDoneGround()`, `concealedByPlaster()`, `unit()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (3 nodes): `handleClose()`, `onKey()`, `StakeholderLedgerDrawer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (3 nodes): `downloadGRNChallan()`, `fmtDate()`, `grnChallan.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (3 nodes): `insertionIndex()`, `withNewTask()`, `add.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (3 nodes): `placeOf()`, `stageOfFloorless()`, `stages.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `parseAmount()` connect `Community 2` to `Community 25`, `Community 11`, `Community 5`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **Why does `NewInvoice()` connect `Community 11` to `Community 25`, `Community 2`, `Community 12`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 13` to `Community 3`, `Community 21`, `Community 7`?**
