...
## Summary
- 3609 nodes · 5716 edges · 80 communities detected
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 877 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (159): answerBillPayment(), billAi(), billRawText(), billReplyKind(), findPrecedingCaption(), fmtNum(), isCleanAmount(), parseBillAnswer() (+151 more)
...
Cohesion: 0.02
Nodes (116): intakeCommit(), intakeExtract(), intakeResolveVendor(), runIntake(), linkParts(), rankLoosePayments(), convertLegacyPoBill(), createBill() (+108 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (92): d(), call(), issue(), prog(), seed(), task(), decideAssociation(), photoRelatedness() (+84 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (32): baseSeed(), twoAskSeed(), ask(), ctxFor(), model(), tUpdated(), upd(), base() (+24 more)
...
Cohesion: 0.03
Nodes (64): confirm(), commit(), autoSettleCrewWages(), cardKeyToCols(), cellFrom(), commitCrewSettlement(), crewPhases(), iso() (+56 more)
...
Cohesion: 0.07
Nodes (37): balStr(), downloadPartyStatementExcel(), fmtDate(), money(), ordered(), particularsOf(), vchNo(), vchType() (+29 more)
...
Cohesion: 0.06
Nodes (14): wa(), buildComponents(), buildTemplateMessage(), sendTemplate(), line(), promptFor(), withTask(), cadenceFor() (+6 more)
...
- **Why does `parseAmount()` connect `Community 1` to `Community 9`, `Community 20`, `Community 15`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `NewInvoice()` connect `Community 20` to `Community 8`, `Community 1`, `Community 9`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `show()` connect `Community 3` to `Community 13`, `Community 15`?**
