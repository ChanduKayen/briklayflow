...
## Corpus Check
- 708 files · ~1,311,314 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3077 nodes · 4800 edges · 75 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 680 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (33): baseSeed(), twoAskSeed(), tUpdated(), upd(), ctxFor(), imgCtx(), tQItem(), tTaskUpdate() (+25 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (102): composeLLM(), fallbackReply(), isGreeting(), runConcierge(), systemFor(), userContent(), answerProcurement(), commitInterruptedProc() (+94 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (74): daysLeft(), digits(), doEnable(), intlPhone(), local10(), onToggle(), prettyPhone(), roleLabel() (+66 more)
...
Cohesion: 0.03
Nodes (59): classifyPhotoFollowup(), wa(), buildComponents(), buildTemplateMessage(), sendTemplate(), line(), promptFor(), withTask() (+51 more)
...
Cohesion: 0.06
Nodes (69): imageDeterministic(), parseDigitToken(), parseSpokenAmount(), callClaude(), callOpenAI(), classifyImage(), classifyImageAnthropic(), classifyImageOpenAI() (+61 more)
...
Cohesion: 0.04
Nodes (28): parseAmount(), readStoredSession(), useAuth(), useCan(), useOrgId(), classifyRefreshError(), extractErrorCode(), parseStoredSession() (+20 more)
...
Cohesion: 0.05
Nodes (34): addCrewForm(), addDepartment(), addWorkerForm(), applyFilter(), bind(), col(), dayCell(), fail() (+26 more)
...
Cohesion: 0.22
Nodes (3): inr(), inr(), UiLivingSentence()
...
- **Thin community `Community 31`** (15 nodes): `add()`, `capitalizeWords()`, `FieldQuestion()`, `fieldStyle()`, `h()`, `matchGenHeads()`, `normHead()`, `openCreate()`, `pickGeneralHead()`, `rm()`, `selectPayee()`, `uid()`, `up()`, `update()`, `ResolvePopup.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 126`** (3 nodes): `downloadGRNChallan()`, `fmtDate()`, `grnChallan.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (3 nodes): `poGateState()`, `poIsPriced()`, `poLifecycle.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `parseAmount()` connect `Community 12` to `Community 3`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `normalizeTxn()` connect `Community 8` to `Community 17`, `Community 10`, `Community 5`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `capFirst()` connect `Community 5` to `Community 8`?**
