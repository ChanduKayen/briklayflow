...
## Corpus Check
- 731 files · ~1,339,862 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3181 nodes · 4972 edges · 76 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 713 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (109): commitInterruptedProc(), answerSiteops(), answerWithPhoto(), applyBatchResolution(), applyQcFailures(), applyTaskBlockedById(), applyTaskProgressById(), applyTaskUpdate() (+101 more)
...
Cohesion: 0.02
Nodes (80): classifyPhotoFollowup(), tradeWords(), d(), call(), issue(), prog(), seed(), task() (+72 more)
...
Cohesion: 0.04
Nodes (85): answerPaymentTotal(), answerReporting(), groupBySite(), loadProjects(), loadStakeholders(), num(), orderRows(), pickFrom() (+77 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (70): daysLeft(), digits(), doEnable(), intlPhone(), local10(), onToggle(), prettyPhone(), roleLabel() (+62 more)
...
Cohesion: 0.04
Nodes (94): answerProcurement(), finalizeDirectVendor(), flowIdFor(), handleSingle(), loadApprover(), loadProjects(), loadVendors(), markReadyForApproval() (+86 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (66): composeLLM(), fallbackReply(), isGreeting(), runConcierge(), systemFor(), userContent(), stampPossibleFollowup(), file() (+58 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (52): backfillOrg(), backfillParty(), deriveCertified(), num(), today(), deriveParty(), num(), parityOrg() (+44 more)
...
Cohesion: 0.11
Nodes (35): callOpenAI(), classifyImage(), classifyImageAnthropic(), classifyImageOpenAI(), classifyIntent(), classifyIntentAI(), classifyMessage(), isValidClass() (+27 more)
...
Cohesion: 0.17
Nodes (2): submit(), submitWorkCertification()
...
- **Thin community `Community 34`** (15 nodes): `add()`, `capitalizeWords()`, `FieldQuestion()`, `fieldStyle()`, `h()`, `matchGenHeads()`, `normHead()`, `openCreate()`, `pickGeneralHead()`, `rm()`, `selectPayee()`, `uid()`, `up()`, `update()`, `ResolvePopup.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (12 nodes): `inr()`, `submit()`, `computeCertAmount()`, `decideWorkCertification()`, `loadLedgerCutover()`, `loadMilestoneCertified()`, `loadPendingCertifications()`, `setEngagementBasis()`, `setLedgerCutover()`, `submitWorkCertification()`, `CertificationWizard.tsx`, `workCertification.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 129`** (3 nodes): `poGateState()`, `poIsPriced()`, `poLifecycle.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (3 nodes): `insertionIndex()`, `withNewTask()`, `add.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (3 nodes): `placeOf()`, `stageOfFloorless()`, `stages.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `parseAmount()` connect `Community 5` to `Community 20`?**
  _High betweenness centrality (0.161) - this node is a cross-community bridge._
- **Why does `NewInvoice()` connect `Community 20` to `Community 10`, `Community 19`, `Community 5`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `saveRefBill()` connect `Community 5` to `Community 11`?**
