...
## Corpus Check
- 611 files · ~1,202,910 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2597 nodes · 4033 edges · 65 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 550 edges (avg confidence: 0.8)
...
- `mediaComposite()` --calls--> `runSiteops()`  [INFERRED]
  supabase\functions\whatsapp-webhook\_siteops_media.ts → supabase\functions\whatsapp-webhook\_agents\siteops.ts

## Communities

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (79): answerSiteops(), answerWithPhoto(), applyBatchResolution(), applyQcFailures(), applyTaskBlockedById(), applyTaskProgressById(), applyTaskUpdate(), applyTerminals() (+71 more)
...
Cohesion: 0.02
Nodes (29): baseSeed(), twoAskSeed(), ask(), ctxFor(), model(), base(), nearest(), upd() (+21 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (75): composeLLM(), fallbackReply(), isGreeting(), runConcierge(), systemFor(), userContent(), stampPossibleFollowup(), cancelTransaction() (+67 more)
...
Cohesion: 0.03
Nodes (48): classifyPhotoFollowup(), buildComponents(), buildTemplateMessage(), sendTemplate(), line(), promptFor(), withTask(), cadenceFor() (+40 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (76): answerProcurement(), commitInterruptedProc(), finalizeDirectVendor(), flowIdFor(), handleSingle(), loadApprover(), loadProjects(), loadVendors() (+68 more)
...
Cohesion: 0.08
Nodes (60): answerTransaction(), applyPlan(), applyPrefix(), buildPlan(), commitEntry(), commitInterrupted(), fmtNum(), handleWriteFailure() (+52 more)
...
Cohesion: 0.07
Nodes (38): parseAmount(), commitEdit(), handleSave(), callOpenAI(), classifyImage(), classifyImageAnthropic(), classifyImageOpenAI(), classifyIntent() (+30 more)
...
Cohesion: 0.08
Nodes (26): tUpdated(), upd(), dayBookLink(), entryLink(), problemLink(), reviewLink(), taskLink(), todayLink() (+18 more)
...
## Knowledge Gaps
- **Thin community `Community 24`** (24 nodes): `acrossFlats()`, `applyUndo()`, `bumpDuration()`, `canClose()`, `closeItem()`, `firstName()`, `floorName()`, `groupIsFoldable()`, `hasLiveWork()`, `isOldAge()`, `openBlockers()`, `pctDone()`, `planFloors()`, `reopenItem()`, `setTaskState()`, `sevScore()`, `siteCodeOf()`, `sliceFloor()`, `snapshot()`, `splitRefs()`, `taskStatus()`, `upNextRefs()`, `derive.ts`, `statusOf()`
...
- **Why does `NewInvoice()` connect `Community 20` to `Community 16`, `Community 11`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `parseAmount()` connect `Community 11` to `Community 8`, `Community 20`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `materializeProjectTasksUncached()` connect `Community 1` to `Community 0`, `Community 23`?**
