# Graph Report - Briklay Fly  (2026-07-15)

## Corpus Check
- 616 files · ~1,211,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2616 nodes · 4059 edges · 66 communities detected
...
Cohesion: 0.04
Nodes (81): answerProcurement(), commitInterruptedProc(), finalizeDirectVendor(), flowIdFor(), handleSingle(), loadApprover(), loadProjects(), loadVendors() (+73 more)
...
Cohesion: 0.07
Nodes (64): answerTransaction(), applyPlan(), applyPrefix(), buildPlan(), cancelTransaction(), commitEntry(), commitInterrupted(), fmtNum() (+56 more)
...
Cohesion: 0.06
Nodes (33): useDeskApi(), useMockDeskApi(), ago(), assignReasonOf(), buildChase(), buildStory(), buildTaskStory(), capitalise() (+25 more)
...
Cohesion: 0.08
Nodes (31): imgCtx(), runTurn(), seed(), task(), checkExprAt(), findMigrationsDir(), loadEnumChecks(), parseEnumExpr() (+23 more)
...
- **Why does `NewInvoice()` connect `Community 13` to `Community 16`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `materializeProjectTasksUncached()` connect `Community 0` to `Community 2`, `Community 19`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `parseAmount()` connect `Community 13` to `Community 8`?**
