...
export default function ProjectBOQs({ session: _session }: { session: Session }) {
    ...
    <div style={{ padding: '28px 24px 64px', maxWidth: 960, margin: '0 auto' }}>
      <div style={{ marginBottom: 32 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
          ...
          <span style={{ fontSize: 12, color: '#0b1c30', fontWeight: 600 }}>BOQs</span>
        </div>
        <h1 style={{ fontSize: 22, fontWeight: 800, color: '#0b1c30', letterSpacing: '-0.02em', fontFamily: 'Manrope, sans-serif' }}>Bill of Quantities</h1>
      </div>
      ...
      <div style={{
        ...
        <div style={{ width: 64, height: 64, borderRadius: '50%', background: 'rgba(0,0,0,0.04)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
          <span className="material-symbols-outlined" style={{ fontSize: 28, color: 'rgba(0,0,0,0.25)' }}>format_list_numbered</span>
        </div>
        <p style={{ fontSize: 17, fontWeight: 700, color: '#0b1c30', marginBottom: 8, fontFamily: 'Manrope, sans-serif' }}>BOQ tracking coming soon</p>
        <p style={{ fontSize: 13, color: 'rgba(0,0,0,0.40)', maxWidth: 320, margin: '0 auto', lineHeight: 1.6 }}>
          Define quantities, rates, and track actual vs. estimated costs for every line item across your project.
        </p>
      </div>
    </div>
  )
