...
// Source: standalone privacy.html, scoped under `.bk-privacy` so the bare
// element selectors (body/h1/h2/…) don't leak into the rest of the app.
  ...
  return (
    <div className="bk-privacy">
      <style>{`
        ...
        .bk-privacy * { box-sizing: border-box; }
        .bk-privacy .wrap { max-width: 720px; margin: 0 auto; padding: 64px 24px 96px; }
        .bk-privacy header { border-bottom: 1px solid var(--line); padding-bottom: 24px; margin-bottom: 40px; }
        .bk-privacy h1 { font-size: 30px; margin: 0 0 8px; letter-spacing: -0.01em; }
        .bk-privacy .meta { color: var(--muted); font-size: 14px; }
        .bk-privacy h2 { font-size: 19px; margin: 40px 0 12px; letter-spacing: -0.01em; }
        .bk-privacy p, .bk-privacy li { color: var(--ink); font-size: 16px; }
        .bk-privacy a { color: var(--accent); }
        .bk-privacy ul { padding-left: 20px; }
        .bk-privacy li { margin-bottom: 6px; }
        .bk-privacy .note {
