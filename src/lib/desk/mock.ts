...
export const MOCK_PROBLEMS: DeskProblem[] = [
  {
    ...
    story: [
      ...
      { t: 'event', l: 'Babai asked Jaggu on WhatsApp', w: '5 days ago' },
      { t: 'msg', from: 'Jaggu', text: 'Tanker union strike sir, will check tomorrow', w: '5 days ago' },
      { t: 'event', l: 'Babai asked again — “[DSR-21] any update on water?”', w: '3 days ago' },
      { t: 'miss', l: 'No reply since', w: '4 days silent' },
    ],
    guide: 'Babai has chased twice. His last reply mentioned a tanker strike — that may have ended. <b>This needs your voice now.</b>',
  ...
  },
  {
    ...
    story: [
      ...
      { t: 'event', l: 'Babai checked against estimate — 8% over, within slab variance', w: '2 days ago' },
      { t: 'miss', l: 'Sent to you for approval', w: 'waiting 2 days' },
    ],
    guide: "Slab work <b>pauses without this</b>. Babai's check says the quantity is plausible. Approving notifies Hari instantly.",
  ...
  },
  {
    ...
    story: [
      ...
      { t: 'event', l: 'Babai chased for a delivery date', w: '3 days ago' },
  ...
  },
  {
    ...
    guide: "Second-fix wiring is <b>blocking the painters</b>. He's answered Babai but not delivered — your word carries more weight.",
  ...
  },
  {
    ...
    status: 'Babai chases again tomorrow morning if no reply',
    story: [
      { t: 'event', l: 'Babai asked JK Rao — “[ASM-15] doors sorted?”', w: '9 am today' },
      { t: 'event', l: 'Message read', w: '11 am' },
      // HONEST-COPY: was "If no reply by 6 pm, Babai chases again".
      { t: 'next', l: 'If no reply, Babai chases again tomorrow morning', w: 'automatic' },
    ],
    guide: 'Nothing needed from you. Babai keeps following up until JK Rao answers.',
    secondary: 'Close',
  },
  {
    ...
    story: [
      ...
      { t: 'next', l: 'Babai asked for a photo of the fix by tonight', w: 'automatic' },
    ],
  ...
  },
  {
    ...
    story: [
      ...
      { t: 'next', l: 'Babai reminds them tomorrow morning', w: 'automatic' },
    ],
  ...
  },
  {
    ...
    photoPending: true,
    status: 'High severity · Babai asked Ravi for a photo',
    story: [
      { t: 'event', l: 'Reported on phone call — damp patch near AC point', w: '3 hours ago' },
      { t: 'event', l: 'Babai asked Ravi on WhatsApp for a photo of the patch', w: '2 hours ago' },
      // HONEST-COPY: was "If no photo by evening, Babai asks again".
      { t: 'next', l: 'If no photo, Babai asks again tomorrow', w: 'automatic' },
    ],
    guide: 'Seepage is treated as <b>high severity</b> — it chases daily. No photo yet; Babai is collecting it so the plumber sees exactly what to trace.',
    secondary: 'Close',
  },
  {
    ...
    guide: 'Ramesh says done and the fix photo is in. <b>Babai has pre-filled the resolution</b> — confirm and it closes.',
  ...
  },
  {
    ...
    guide: 'On track. When the site team confirms it landed, Babai will propose closing this.',
  ...
  },
  {
    ...
    story: [
      ...
      { t: 'next', l: 'Babai asks for a photo when they say it’s done', w: 'automatic' },
    ],
  ...
  /* ---------- Sorted (history stays) ---------- */
  {
    ...
    resolution: { outcome: 'Fixed', note: 'Delivered in full. Challan matched against order; count confirmed by Ravi.', by: 'Babai — auto-closed', when: '2 days ago' },
  },
  {
